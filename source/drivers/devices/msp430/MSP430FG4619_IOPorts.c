...
void initialize_msp430_IO_ports(void)
{
	...
	initializeSerialOutput (	&msp430.PORT_3.serialOutput[0],		3,	0	);
	initializeSerialOutput (	&msp430.PORT_3.serialOutput[1],		3,	1	);
	initializeSerialInput  (	&msp430.PORT_3.serialInput[0],		3,	2	);
	initializeSerialInput  (	&msp430.PORT_3.serialInput[1],		3,	3	);
